...
var methodsAttempt []map[string]interface{} = []map[string]interface{}{
	...
	{"method": "SetSrc", "args": []interface{}{"https://github.com/realPy/hogosuru/base/blob/main/ressources/virtualRendering.png?raw=true"}, "gettermethod": "Src", "resultattempt": "https://github.com/realPy/hogosuru/base/blob/main/ressources/virtualRendering.png?raw=true"},
